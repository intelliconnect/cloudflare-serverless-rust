...
pub async fn main(req: Request, env: Env, _ctx: worker::Context) -> Result<Response> {
    ...
    router
        ...
        // get by data by using filter
        .get_async("/filtered_data", |mut req, ctx| async move {
            // since
            let json_data = req.json::<serde_json::Value>().await?;  // Replace this with your filter criteria
